...
class ResNetAdvProp_imagnet(nn.Module):

    def __init__(self, block, layers, num_classes=128,  bn_adv_flag=False, bn_adv_momentum=0.01):
        super(ResNetAdvProp_imagnet, self).__init__()
        self.inplanes = 64
        self.bn_adv_flag = bn_adv_flag
        self.bn_adv_momentum = bn_adv_momentum
...
def resnet18_imagenet(num_classes=128, bn_adv_flag=False, bn_adv_momentum=0.01):
    return ResNetAdvProp_imagnet(BasicBlock, [2,2,2,2], num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)


def resnet34_imagenet(num_classes=128, bn_adv_flag=False, bn_adv_momentum=0.01):
    return ResNetAdvProp_imagnet(BasicBlock, [3,4,6,3], num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)


def resnet50_imagenet(num_classes=128, bn_adv_flag=False, bn_adv_momentum=0.01):
    return ResNetAdvProp_imagnet(Bottleneck, [3,4,6,3], num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)


def resnet101_imagenet( num_classes=128, bn_adv_flag=False, bn_adv_momentum=0.01):
    return ResNetAdvProp_imagnet(Bottleneck, [3,4,23,3], num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)


def resnet152_imagenet(num_classes=128, bn_adv_flag=False, bn_adv_momentum=0.01):
    return ResNetAdvProp_imagnet(Bottleneck, [3,8,36,3], num_classes, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
